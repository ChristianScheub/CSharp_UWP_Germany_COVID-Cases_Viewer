...
using Deutschland_Fallzahlen.Helpers;
...
namespace Deutschland_Fallzahlen.Views
{
    ...
    public sealed partial class SettingsPage : Page, INotifyPropertyChanged
    {
        ...
        private void button_landkreis_speichern_Click(object sender, RoutedEventArgs e)
        {
            ApplicationData.Current.LocalSettings.Values["landkreis"] = textBox_landkreis.Text;
        }
    }
}
